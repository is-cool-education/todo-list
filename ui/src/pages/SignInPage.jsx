    ...
    <Box sx={{ height: "100vh", display: "grid", justifyContent: "center", alignItems: "center" }}>
      <Card sx={{ width: { xs: "90%", sm: "500px" } }} elevation={10} component="form" onSubmit={onSubmit}>
        ...
        <CardContent sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
          <TextField name="username" label="Usuário" error={!!errors.username} helperText={errors.username} />
          <TextField name="password" label="Senha" error={!!errors.password} helperText={errors.password} />
        </CardContent>
